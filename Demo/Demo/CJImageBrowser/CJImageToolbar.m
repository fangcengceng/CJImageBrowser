...
- (void)setPhotos:(NSArray *)photos
{
    ...
    [_saveImageBtn setImage:[UIImage imageNamed:@"save_icon"] forState:UIControlStateNormal];
    [_saveImageBtn setImage:[UIImage imageNamed:@"save_icon_select"] forState:UIControlStateHighlighted];
